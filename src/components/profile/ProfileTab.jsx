        ...
        <>
            <div className="profile-tab">
                <div className="text-center">
                    <NavLink end to="/patelmj04" className={({isActive})=>(isActive ? 'active px-4 mx-2' : 'text-muted px-4 mx-2')}>
                    ...
                    <NavLink end to="/patelmj04/saved" className={({isActive})=>(isActive ? 'active px-4 mx-2' : 'text-muted px-4 mx-2')}>
                    ...
                    <NavLink end to="/patelmj04/tagged" className={({isActive})=>(isActive ? 'active px-4 mx-2' : 'text-muted px-4 mx-2')}>
